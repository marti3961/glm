      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Locales en renta</li>
          </ol>
        </div>
      </nav>
    </div>
        ...
        <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            <div class="swiper-slide">
              <img src="images/proyectos-nuevos/locales.jpg" alt="">
            </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8" data-aos="fade-up">
            ...
            <div class="portfolio-description">
              <h2>¡Tu próximo negocio puede estar aquí!</h2>
              <p>
                 GLM te ofrece locales comerciales en renta dentro del fraccionamiento San Antonio Pachuquilla, ubicados estratégicamente en la zona comercial, justo a la entrada del desarrollo.
              </p>
              <p>
                 A solo unos pasos de la parada de transporte y la caseta de acceso, estos locales cuentan con una ubicación privilegiada que asegura alta afluencia de personas todos los días.
              </p>

              <p>
                Con más del 90% del fraccionamiento ya habitado, es el momento ideal para abrir o expandir tu negocio en una zona con gran potencial.
              </p>

              <p>
                Contáctanos y conoce las opciones disponibles. ¡Haz crecer tu negocio en el mejor punto de la zona!
              </p>
            </div>
